...
const Videos = () => {
  ...
  const videosArr = [
    'https://www.youtube.com/watch?v=ooKfnvPAP8I',
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/ooKfnvPAP8I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
   ...
   <Stack direction={['column','row']} height={'100vh'}>
    <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>This is a Sampel videos
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum aliquam, impedit soluta voluptas laudantium sint reiciendis aut nisi perspiciatis quia cumque, quo in omnis quos tempora fugiat doloremque molestiae suscipit nobis. Obcaecati non nisi ipsum suscipit fugiat.
          </Text>
        </VStack>
    ...
    <VStack width={['full','xl']} alignItems={'stretch'} p={'8'} spacing={'8'} overflowY={'auto'} >
     {videosArr.map((item,index)=>(
       <Button variant={'ghost'} colorScheme={'purple'} onClick={()=> setVideoSrc(item)}>Lectuer {index +1}</Button>
     ))}
    </VStack>
   </Stack>
  )
